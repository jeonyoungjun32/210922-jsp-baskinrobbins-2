...
<link rel="stylesheet" type="text/css" href="/baskinrobbins/css/mypageAside.css"/>
<link rel="stylesheet" type="text/css" href="https://unpkg.com/aos@2.3.1/dist/aos.css" />
<!-- js -->
<script type="text/javascript" src="js/jquery-3.6.0.min.js"></script>
<script type="text/javascript" src="/baskinrobbins/js/mypageUpdate.js"></script>
...
/* mypage */
$(function(){
    $('.nav_f_li').on('click',function(){
        $('.nav_f_li').toggleClass('nav_active');
        if($('.nav_f_li').hasClass('nav_active')) {
            $('.nav_f_li').css({
                height:"150px"
            })
        } else {
        ...
        <div class="header_top">
            <nav class="scroll_box">
                <ul>
                    ...
                    <li><a href="#section" class="section">section</a></li>
                    <li><a href="#footer" class="footer">footer</a></li>
                </ul>
            </nav>
            <a href="index.bk"><img src="img/logoimg.png" alt="logo_img" class="logo_img"></a>
            <div class="text_box">
                ...
                <div class="login_box">
                <% if(member == null) { %>
                    <a href="login.bk">login</a>
                <%} else if (member != null) {%>
                	<a href="memberMypage.bg"><%=member.getId() %></a>
                	<a href="logOutPro.bk">logout</a>
                <%} %>
                </div>
            </div>
        </div>
            ...
            <ul>
                ...
                <li class="nav_li">
                    ...
                    <ul>
                        ...
                        <li><a href="iceCakeList.PI">아이스크림케이크</a></li>
                        <li><a href="#">음료</a></li>
                        <li><a href="CoffeeList.PI">커피</a></li>
                        <li><a href="#">디저트</a></li>
                    </ul>
                </li>
                <li class="nav_li">
